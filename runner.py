...
while True:
    ...
    if mode == '1':
        ...
        id=input("Enter id of Student you wish to remove: \n" ) 
        next((school.remove_student(id) for item in school.students if item.school_id == id), 'there is no student with that id')
    elif mode == '5':
        break
